...
```json
{
  "BROWSERBASE_API_KEY": "bb_live_VM4UZBDhjWbaThMm3dFkoizTewQ",
  "BROWSERBASE_PROJECT_ID": "60253a5f-86a8-4765-8ce4-fb57ce763949",
  "GEMINI_API_KEY": "AIzaSyAJFwSvwYnyur0UyXzOgWPuUUdRjLudzsE"
}
```
...
- ✅ Successfully created session via direct API call: `89e524fe-2740-42f6-9f5c-13c3af0d2a44`
...
```json
{
  "OXYLABS_AI_STUDIO_API_KEY": "PWxLiw84Ue2OlCtyYLR5n5nyYbaUMuie17sAXyH0"
}
```
...
# ~/.claude.json contains:
{
  "oxylabs": {
    ...
    "args": ["oxylabs-mcp"],
    "env": {
      "OXYLABS_USERNAME": "apelosi@alum.mit.edu",
      "OXYLABS_PASSWORD": "HEX2tgf4mcx9vyd_ehn",
      "OXYLABS_AI_STUDIO_API_KEY": "PWxLiw84Ue2OlCtyYLR5n5nyYbaUMuie17sAXyH0"
    }
  }
}
